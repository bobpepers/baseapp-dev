...
describe('Helpers', () => {
    ...
    it('Should return correct deposit status color', () => {
        ...
        expect(helpers.setDepositStatusColor('canceled')).toEqual('var(--red)');
        expect(helpers.setDepositStatusColor('rejected')).toEqual('var(--red)');
    });
