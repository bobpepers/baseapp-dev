        ...
        return (
            <Fragment>
                <Switch>
                    ...
                    <Route exact={true} path="/vote" component={VotingScreen} />
                    <Route exact={true} path="/status" component={StatusScreen} />
                    <Route exact={true} path="/fees" component={FeeScreen} />
                    <Route exact={true} path="/docs-api" component={ApiScreen} />
                    ...
                    <PrivateRoute loading={userLoading} isLogged={isLoggedIn} path="/wpanel/dashboard" component={DashboardScreen} />
